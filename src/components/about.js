        ...
        <div className='container'>
            ...
            <div className='row col-12 m-0'>
                <div className='about-image col-sm-12 col-lg-6'>
                    <img src={about1} alt='' className='col-6' style={{ width: '16rem' }}/>
                    <img src={about2} alt='' className='col-6' style={{ width: '16rem' }}/>
                    <img src={about3} alt='' className='col-6' style={{ width: '16rem' }}/>
                    <img src={about4} alt='' className='col-6' style={{ width: '16rem' }}/>
                </div>
